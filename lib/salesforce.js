        ...
        try {
            ...
            this.#sfConnection.sobject(objectName).create(record, (error, res) => {
                ...
                if (!res.success) {
                    ...
                    return callback ? callback(new Error(`Error creating record.  Ererors were ${errors}`)) : Promise.reject(new Error(`Error creating record.  Ererors were ${errors}`))
                }
